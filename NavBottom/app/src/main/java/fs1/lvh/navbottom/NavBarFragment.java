...
public class NavBarFragment extends Fragment {
    ...
    private Fragment homeFragment, tab1Fragment, tab2Fragment;
    ...
    public NavBarFragment() {
        ...
        tab1Fragment = new OneFragment();
        tab2Fragment = new TwoFragment();
